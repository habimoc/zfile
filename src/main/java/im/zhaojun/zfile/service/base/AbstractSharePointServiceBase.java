...
public abstract class AbstractSharePointServiceBase extends AbstractBaseFileService {
    ...
    protected static final String DRIVER_ITEMS_URL = "https://{graphEndPoint}/v1.0/sites/{sharePointSiteId}/drive/root:{path}:/children";

    protected static final String DRIVER_ITEM_URL = "https://{graphEndPoint}/v1.0/sites/{sharePointSiteId}/drive/root:{path}";
